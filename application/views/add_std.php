...
<label>Department:</label><select name="dept" class="cl">
	<option name="ftca">ftcs</option>
	<option name="fcbm">fcbm</option>
</select><br><br>
<label>Course_id:</label><input type="text" class="cl" name="course" required><br><br>
<label>Semester_id:</label><input type="text" class="cl" name="semester" required><br><br>
